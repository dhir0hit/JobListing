...
<%--Body--%>
    ...
    <div class="container d-flex flex-column justify-content-center align-items-center col-md-4">
        <div class="w-100 d-flex flex-column">
            <h3 class="display-6">Welcome, User Name</h3>
            ...
            <div class="p-5 m-5 border border-secondary rounded d-flex flex-row justify-content-between align-items-center">
                <div>
                    <h5 class="" id="user-full-name">User Full Name</h5>
                    <h6><a href="#" class="text-decoration-none">example@mail.com</a></h6>
<%--                    <a href="#" class="text-primary text-decoration-none">Change Password</a>--%>
                    <h6 >Address, Add, Ad</h6>
                </div>
            ...
            <div class="d-flex flex-row justify-content-evenly align-items-center bg-secondary p-3 m-1 rounded">
...
<div class="container">
    ...
    <script>
        window.onload = function () {
            ...
            document.getElementById("initials").innerHTML = userName[0][0] + "<span class='text-white'>"+ userName[2][0] + "</span>"
        }
    </script>
